...
import img from "../page2__imgs/page2__img5.png"
...
function Page2__card1(){
    return(
        <div className="Page2__card__type1">
                ...
                <div className="Page2__extra__redCard">-20%</div>
               ...
               <img className="Page2__card__img" src={img}alt="" />
                <div className="Page2__card__text">Modern Outdoor Chair</div>
                <div className="Page2__card__price">$79.00</div>
